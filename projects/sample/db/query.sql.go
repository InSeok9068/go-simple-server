...
SELECT bio, created, id, name, updated FROM authors WHERE id = ? LIMIT 1
`
...
SELECT bio, created, id, name, updated FROM authors ORDER BY name
`
...
WHERE
    id = ? RETURNING bio, created, id, name, updated
`
