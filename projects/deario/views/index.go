		...
		Body: []Node{
			...
			Main(
				...
				Nav(
					...
					// 	),
					// ),
					Button(Class("chip"), Attr("onclick", "showModal('#cbt-dialog')"),
						I(Text("psychology_alt")),
						Text("CBT"),
					),
					Button(Class("chip"), Attr("onclick", "showModal('#diary-image-dialog')"),
						I(Text("image")),
						Text("이미지"),
					),
					Div(Class("max")),
			...
			/* Footer */
			Nav(Class("bottom"),
				A(Href("#"), Attr("onclick", "showModal('#calendar-dialog')"),
					I(Text("calendar_month")),
					Text("달력"),
				),
				A(Href("#"), Attr("onclick", "showModal('#diary-list-dialog')"),
					I(Text("list_alt")),
					Text("일지"),
				),
				...
				A(Href("#"), Attr("onclick", "showModal('#menu-dialog')"),
					I(Text("menu_open")),
					Text("메뉴"),
				),
			),
			...
			Dialog(ID("cbt-dialog"), Class("max"),
				...
				Nav(Class("right-align"),
					Button(Type("button"), Attr("onclick", "closeModal('#cbt-dialog')"),
						Text("확인"),
					),
				),
			),
			...
			Dialog(ID("calendar-dialog"), Class("max"),
				...
				Nav(Class("right-align"),
					Button(Type("button"), Attr("onclick", "closeModal('#calendar-dialog')"), Text("닫기")),
				),
			),
			...
			Dialog(ID("diary-image-dialog"), Class("max"),
				...
				Nav(Class("right-align"),
					Button(Type("button"), Attr("onclick", "closeModal('#diary-image-dialog')"), Text("닫기")),
				),
			),
			...
			Dialog(ID("diary-list-dialog"), Class("max"),
				...
				Div(x.Data("{ page : 1 }"),
					...
					Nav(Class("right-align"),
						Button(Type("button"),
							Attr("onclick", "closeModal('#diary-list-dialog')"),
							Text("확인"),
						),
					),
				),
			...
			Dialog(ID("menu-dialog"), Class("right"),
				...
				Nav(Class("right-align"),
					Button(Type("button"),
						Attr("onclick", "closeModal('#menu-dialog')"),
						Text("확인"),
					),
				),
			),
