		...
		Body: []Node{
			...
			Main(
				...
				Nav(
					...
					Button(Class("chip"), Attr("data-ui", "#diary-image-dialog"),
						I(Text("image")),
						Text("이미지"),
					),
					Div(Class("max")),
			...
			/* Footer */
			Nav(Class("bottom"),
				A(Href("#"), Attr("data-ui", "#calendar-dialog"),
					Attr("onclick", "showCalendar()"),
					I(Text("calendar_month")),
					Text("달력"),
				),
				A(Href("#"), Attr("data-ui", "#diary-list-dialog"),
					I(Text("list_alt")),
					Text("일지"),
				),
				...
				A(Href("#"), Attr("data-ui", "#menu-dialog"),
					I(Text("menu_open")),
					Text("메뉴"),
				),
			),
			...
			Dialog(ID("cbt-dialog"), Class("max"),
				...
				Nav(Class("right-align"),
					Button(Type("button"), Attr("data-ui", "#cbt-dialog"),
						Text("확인"),
					),
				),
			),
			...
			Dialog(ID("ai-feedback-dialog"), Class("max"),
				...
				Form(
					...
					Nav(Class("right-align"),
						...
						Button(Type("button"), Attr("data-ui", "#ai-feedback-dialog"),
							Text("확인"),
						),
					),
				),
			...
			Dialog(ID("calendar-dialog"), Class("bottom"),
				...
				Nav(Class("right-align"),
					Button(Type("button"), Attr("data-ui", "#calendar-dialog"), Text("닫기")),
				),
			),
