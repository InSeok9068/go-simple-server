					...
					FieldSet(
						...
						Div(Class("field border label"),
							Select(
								...
								Option(Value("gamja"), Text("감자꽃 (기본)")),
								Option(Value("humanist"), Text("따뜻한 휴머니스트")),
								Option(Value("neo_grotesque"), Text("깔끔한 모던 산세리프")),
								Option(Value("monospace_code"), Text("코드 느낌 모노스페이스")),
								Option(Value("industrial"), Text("빈티지 인더스트리얼")),
								Option(Value("rounded_sans"), Text("동글동글 라운드 산세리프")),
							),
							Label(Text("폰트")),
						),
