...
func HeadsDefault(title string) []Node {
	return []Node{
		...
		Link(Rel("stylesheet"), Href("https://cdn.jsdelivr.net/npm/open-props@1.7.23/open-props.min.css"),
		...
		Script(Src("https://cdn.jsdelivr.net/npm/htmx-ext-alpine-morph@2.0.2/alpine-morph.js"),
			Attr("onerror", "this.onerror=null;this.src='shared/static/lib/alpine-morph.js';")),
		Script(Src("https://cdn.jsdelivr.net/npm/@alpinejs/persist@3.15.8/dist/cdn.min.js"), Defer(),
			Attr("onerror", "this.onerror=null;this.src='shared/static/lib/persist.cdn.min.js';")),
		Script(Src("https://cdn.jsdelivr.net/npm/@alpinejs/morph@3.15.8/dist/cdn.min.js"), Defer(),
			Attr("onerror", "this.onerror=null;this.src='shared/static/lib/morph.cdn.min.js';")),
		Script(Src("https://cdn.jsdelivr.net/npm/alpinejs@3.15.8/dist/cdn.min.js"), Defer(),
...
func HeadsWithBeer(title string) []Node {
	beer := []Node{
		Link(Rel("stylesheet"), Href("https://cdn.jsdelivr.net/npm/beercss@3.12.13/dist/cdn/beer.min.css"),
