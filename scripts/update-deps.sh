...
check_frontend() {
    ...
    frontend_libs=(
        ...
        "@alpinejs/persist|3.15.5|https://cdn.jsdelivr.net/npm/@alpinejs/persist@%s/dist/cdn.min.js"
        "@alpinejs/morph|3.15.5|https://cdn.jsdelivr.net/npm/@alpinejs/morph@%s/dist/cdn.min.js"
        "alpinejs|3.15.5|https://cdn.jsdelivr.net/npm/alpinejs@%s/dist/cdn.min.js"
