...
sed -i'' -E 's|(cmd = "tailwind/tailwindcss.exe -i tailwind/tailwindcss.css -o shared/static/tailwindcss.css --minify ; templ generate ; go build -o ./main.exe ./projects/)[^"]+(")|\1'"$SERVICE"'/cmd/\2|' "$CONFIG_FILE"
